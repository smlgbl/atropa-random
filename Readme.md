...
This package lives at: [https://npmjs.org/package/atropa-random](https://npmjs.org/package/atropa-random)

Source code available at: [https://github.com/matthewkastor/atropa-random/](https://github.com/matthewkastor/atropa-random/)
...
In the browser this module is attached to the global namespace `atropa`, which
 ...
 Include `./browser/atropa-random_web.js` in your page and
 `atropa.random` will be available in your page.
...
To run the browser tests open `browser/atropa-random_tests.html` in your
...
If you alter the source in `src/atropa-random.js` please run the
